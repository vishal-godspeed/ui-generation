...
const ContactGridLayout: React.FC = () => {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-indigo-400/40 via-blue-300/40 to-purple-300/40">
      ...
      <div className="w-full max-w-6xl mx-auto flex flex-col md:flex-row gap-12 px-4 py-12 md:py-20">
        {/* Left: Contact Form + Follow Us */}
        <div className="flex-1 flex flex-col justify-between">
          <div className="w-full bg-white/30 backdrop-blur-md rounded-2xl p-6 sm:p-10 shadow-lg border border-white/20 flex-1 flex flex-col">
          ...
          {/* Follow Us Section */}
          <div className="bg-white/30 backdrop-blur-md rounded-2xl p-6 shadow-lg border border-white/20 flex flex-col justify-center mt-8">
            <h3 className="text-gray-900 text-xl font-bold mb-2">Follow Us</h3>
            <div className="flex gap-6 text-gray-800 font-bold text-lg">
        ...
        <div className="flex-1 flex flex-col gap-8 justify-between" style={{ minHeight: 0 }}>
          <div className="flex-1 flex flex-col justify-center bg-white/30 backdrop-blur-md rounded-2xl p-6 shadow-lg border border-white/20 mb-4">
            <h2 className="text-gray-900 text-2xl font-bold mb-3">Contact Information</h2>
          ...
          <div className="flex-1 flex items-center justify-center bg-white/30 backdrop-blur-md rounded-2xl shadow-lg border border-white/20 p-0 h-full min-h-0">
            <iframe 
...
export default ContactGridLayout;