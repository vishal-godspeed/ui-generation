...
const Header3: React.FC = () => {
  ...
  return (
    <header className="sticky top-0 z-50 w-full bg-white rounded-2xl shadow-md px-8 py-4 flex flex-col md:flex-row items-center justify-between mt-4 relative">
      <div className="flex items-center w-full md:w-auto">
        ...
        {/* Desktop Navigation */}
        <nav className="hidden md:flex space-x-8 md:ml-10 transition-all duration-200">
      ...
      {/* Desktop Login/CTA */}
      <div className="hidden md:flex items-center space-x-4 mt-4 md:mt-0 transition-all duration-200">
        <a href="#" className="text-gray-800 font-medium hover:text-indigo-600 transition">
          Login
        </a>
        <a 
          href="#" 
          className="bg-[#FFE6E0] text-orange-600 font-semibold px-5 py-2 rounded-md hover:bg-orange-100 transition header-cta"
        >
          Start free trial
        </a>
      </div>
