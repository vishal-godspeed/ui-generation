    ...
    <div className="flex items-center justify-between px-6 py-4 bg-white rounded-2xl shadow-md">
      ...
      <div className="relative group">
        ...
        >
          ...
          <span className="text-xs font-semibold">Asal Design</span>
          <svg className="w-5 h-5 text-gray-400 ml-1" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path d="M19 9l-7 7-7-7"/></svg>
        </button>
        {/* Dropdown */}
        <div className={`absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-lg py-2 ${isDropdownOpen ? 'block' : 'hidden'}`}>
